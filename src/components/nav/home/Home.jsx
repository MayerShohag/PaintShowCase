     ...
     return (
          <>
               <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-12 md:col-start-4 h-screen overflow-auto scroll-smooth scrollbar-thin lg:col-start-3 md:border-l lg:col-end-13 border-gray-700 md:col-span-12">
