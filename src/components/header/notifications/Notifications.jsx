     ...
     return (
          <>
               <div className="max-w-[1014px] mx-auto border border-gray-700 border-t-0">
                    <h1 className="p-4 text-3xl font-bold">Notifications</h1>
                    <div className="">
                              ...
                              <div className="flex py-2 justify-between items-center">
                                   <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                             ...
                                             <p>
                                                  Liked your comment on the 'Oil
                                                  Painting Tutorial: Blending
                                                  Techniques' video. 👍
                                             </p>
                                        </div>
                                   </div>
                              ...
                              <div className="flex py-2 justify-between items-center">
                                   <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                             ...
                                             <p>
                                                  Your listing for the 'Starry
                                                  Night' reproduction expires
                                                  soon. ⏳
                                             </p>
                                        </div>
                                   </div>
